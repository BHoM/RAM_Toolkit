...
namespace BH.Adapter.RAM
{
    public partial class RAMAdapter
    {
        ...
        private List<RAMServiceEndReactions> ReadBeamEndReactions(List<string> ids = null)
        {
            List<RAMServiceEndReactions> barEndReactions = new List<RAMServiceEndReactions>();
            ...
            foreach ( IBeam beam in ramBeams)
            {
                ...
                RAMServiceEndReactions bhomEndReactions = new RAMServiceEndReactions()
                {
                    ObjectId = beam.lUID,
